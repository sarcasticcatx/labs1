...
#
#
# @router.post("/temporary-res/add")
# async def create_temp_acc(createTempAcc: CreateTempAcc, db: Session = Depends(get_db)):
#     try:
...
#     try:
#         result = accomodation_service.reserve_all_temp_acc(db, user_id)
#         if not result:
